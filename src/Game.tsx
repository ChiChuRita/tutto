...
function Scoreboard({
   ...
   * where the rest of the news is read and never off the live position.
   */
  game: GameState | null;
  ...
  return (
    ...
    <div className="flex flex-1 flex-col gap-4">
      ...
      {/* Whose Turn it is and what you have, on every phone at the table —
          ...
          outcome, so it is the settled position's: a Plus/Minus banks its flat
          1000 and docks each of the leaders 1000 in one move, and none of those
          Seats may move while the dice that did it are still turning.
