...
export function Stats() {
  ...
  return (
    <section className="flex flex-col gap-3">
      {/* Named, like every other block on this screen. »Deine Spiele« and
          »Offene Spiele« each carry an `h2`, and this one carried nothing, so
          the page went from `h1` straight into an unheaded panel and a screen
          reader met a stack of numbers with no idea what they were counting.
          WCAG 2.2 AA is binding (`PRODUCT.md`), and this is the cheapest thing
          it asks for. The word is the rulebook's own. */}
      <h2 className="font-display text-lg font-bold">Bilanz</h2>
